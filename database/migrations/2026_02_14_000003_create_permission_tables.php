...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            ...
            if ($teams) {
                ...
                $table->primary([$columnNames['team_foreign_key'] ?? 'team_id', 'permission_id', $columnNames['model_morph_key'], 'model_type'],
        ...
        Schema::create($tableNames['model_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            ...
            if ($teams) {
                ...
                $table->primary([$columnNames['team_foreign_key'] ?? 'team_id', 'role_id', $columnNames['model_morph_key'], 'model_type'],
    ...
    public function down(): void
    {
        ...
        if (empty($tableNames)) {
            throw new RuntimeException('Error: config/permission.php not found.');
        }
