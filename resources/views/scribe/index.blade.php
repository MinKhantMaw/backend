                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-change-password">POST api/v1/auth/change-password</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-auth-sidebar">
                                <a href="#endpoints-GETapi-v1-auth-sidebar">GET api/v1/auth/sidebar</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-roles">POST api/v1/roles</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-roles--role_id-">
                                <a href="#endpoints-GETapi-v1-roles--role_id-">GET api/v1/roles/{role_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-roles--role_id-">
                                <a href="#endpoints-PUTapi-v1-roles--role_id-">PUT api/v1/roles/{role_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-roles--role_id-">
                                <a href="#endpoints-DELETEapi-v1-roles--role_id-">DELETE api/v1/roles/{role_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-roles--role_id--permissions">
                                <a href="#endpoints-PUTapi-v1-roles--role_id--permissions">PUT api/v1/roles/{role_id}/permissions</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-permissions">POST api/v1/permissions</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-permissions--permission_id-">
                                <a href="#endpoints-GETapi-v1-permissions--permission_id-">GET api/v1/permissions/{permission_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-permissions--permission_id-">
                                <a href="#endpoints-PUTapi-v1-permissions--permission_id-">PUT api/v1/permissions/{permission_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-permissions--permission_id-">
                                <a href="#endpoints-DELETEapi-v1-permissions--permission_id-">DELETE api/v1/permissions/{permission_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-customer-register">
                                <a href="#endpoints-POSTapi-v1-auth-customer-register">POST api/v1/auth/customer/register</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-customer-login">
                                <a href="#endpoints-POSTapi-v1-auth-customer-login">POST api/v1/auth/customer/login</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-admin-login">
                                <a href="#endpoints-POSTapi-v1-auth-admin-login">POST api/v1/auth/admin/login</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-cart-items">POST api/v1/cart/items</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-v1-cart-items--item-">
                                <a href="#endpoints-PATCHapi-v1-cart-items--item-">PATCH api/v1/cart/items/{item}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-cart-items--item-">
                                <a href="#endpoints-DELETEapi-v1-cart-items--item-">DELETE api/v1/cart/items/{item}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-webhooks-payments-stripe">
                                <a href="#endpoints-POSTapi-v1-webhooks-payments-stripe">POST api/v1/webhooks/payments/stripe</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-auth-customer-profile">
                                <a href="#endpoints-GETapi-v1-auth-customer-profile">GET api/v1/auth/customer/profile</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-auth-customer-profile">
                                <a href="#endpoints-PUTapi-v1-auth-customer-profile">PUT api/v1/auth/customer/profile</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-customer-logout">
                                <a href="#endpoints-POSTapi-v1-auth-customer-logout">POST api/v1/auth/customer/logout</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-logout-all">POST api/v1/auth/logout-all</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-cart-merge">
                                <a href="#endpoints-POSTapi-v1-cart-merge">POST api/v1/cart/merge</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-v1-orders">GET api/v1/orders</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-orders--order-">
                                <a href="#endpoints-GETapi-v1-orders--order-">GET api/v1/orders/{order}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-admin-products">POST api/v1/admin/products</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-products--product-">
                                <a href="#endpoints-GETapi-v1-admin-products--product-">GET api/v1/admin/products/{product}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-admin-products--product-">
                                <a href="#endpoints-PUTapi-v1-admin-products--product-">PUT api/v1/admin/products/{product}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-admin-products--product-">
                                <a href="#endpoints-DELETEapi-v1-admin-products--product-">DELETE api/v1/admin/products/{product}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-products--product--images">
                                <a href="#endpoints-POSTapi-v1-admin-products--product--images">POST api/v1/admin/products/{product}/images</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-v1-admin-orders">GET api/v1/admin/orders</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-orders--order-">
                                <a href="#endpoints-GETapi-v1-admin-orders--order-">GET api/v1/admin/orders/{order}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-v1-admin-orders--order--status">
                                <a href="#endpoints-PATCHapi-v1-admin-orders--order--status">PATCH api/v1/admin/orders/{order}/status</a>
                            </li>
...
<div class="bash-example">
    ...
    \"mobile_country_code\": \"hfqcoynla\",
    \"mobile_number\": \"zghdtqtqxbajwbpilpmuf\",
    \"password\": \"SJIrIV#lz.\"
}"
</code></pre></div>
...
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>kunde.eloisa@example.com</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>mobile_country_code</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mobile_country_code"                data-endpoint="POSTapi-v1-auth-register"
               value="hfqcoynla"
               data-component="body">
    <br>
<p>Must not be greater than 10 characters. Example: <code>hfqcoynla</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 30 characters. Example: <code>zghdtqtqxbajwbpilpmuf</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>SJIrIV#lz.</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The value and <code>current_password</code> must be different. Must be at least 8 characters. Example: <code>mqeopfuudtdsufvyvddqamniihfqcoynlazghdtqtqxbajwbpilpmufinllwloauydlsmsjuryv</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-v1-auth-sidebar">GET api/v1/auth/sidebar</h2>
...
<span id="example-requests-GETapi-v1-auth-sidebar">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/auth/sidebar" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/auth/sidebar"
);
...
<span id="example-responses-GETapi-v1-auth-sidebar">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-auth-sidebar" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-auth-sidebar"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-auth-sidebar"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-auth-sidebar" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-auth-sidebar">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-auth-sidebar" data-method="GET"
      data-path="api/v1/auth/sidebar"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-auth-sidebar', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-auth-sidebar"
                    onclick="tryItOut('GETapi-v1-auth-sidebar');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-auth-sidebar"
                    onclick="cancelTryOut('GETapi-v1-auth-sidebar');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-auth-sidebar"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/auth/sidebar</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-auth-sidebar"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-auth-sidebar"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mobile_country_code"                data-endpoint="POSTapi-v1-users"
               value="hfqcoynla"
               data-component="body">
    <br>
<p>Must not be greater than 10 characters. Example: <code>hfqcoynla</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mobile_number"                data-endpoint="POSTapi-v1-users"
               value="zghdtqtqxbajwbpilpmuf"
               data-component="body">
    <br>
<p>Must not be greater than 30 characters. Example: <code>zghdtqtqxbajwbpilpmuf</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>inllwloauydlsmsjuryvo</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>)z&amp;~na%x?(F</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    \"name\": \"vmqeopfuudtdsufvyvddq\",
    \"email\": \"kunde.eloisa@example.com\",
    \"address\": \"hfqcoynlazghdtqtqxbaj\",
    \"mobile_country_code\": \"wbpilpmuf\",
    \"mobile_number\": \"inllwloauydlsmsjuryvo\",
    \"password\": \")z&amp;~na%x?(F\",
    \"status\": \"SUSPENDED\",
    \"roles\": [
        \"consequatur\"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="PUTapi-v1-users--user_id-"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mobile_country_code"                data-endpoint="PUTapi-v1-users--user_id-"
               value="wbpilpmuf"
               data-component="body">
    <br>
<p>Must not be greater than 10 characters. Example: <code>wbpilpmuf</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>mobile_number</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mobile_number"                data-endpoint="PUTapi-v1-users--user_id-"
               value="inllwloauydlsmsjuryvo"
               data-component="body">
    <br>
<p>Must not be greater than 30 characters. Example: <code>inllwloauydlsmsjuryvo</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PUTapi-v1-users--user_id-"
               value="SUSPENDED"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="roles[0]"                data-endpoint="PUTapi-v1-users--user_id-"
               data-component="body">
        <input type="text" style="display: none"
               name="roles[1]"                data-endpoint="PUTapi-v1-users--user_id-"
               data-component="body">
    <br>
<p>The <code>name</code> of an existing record in the roles table.</p>
        </div>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>api</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>The <code>name</code> of an existing record in the permissions table.</p>
                    ...
                    <h2 id="endpoints-GETapi-v1-roles--role_id-">GET api/v1/roles/{role_id}</h2>
...
<span id="example-requests-GETapi-v1-roles--role_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-roles--role_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-roles--role_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-roles--role_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-roles--role_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-roles--role_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-roles--role_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-roles--role_id-" data-method="GET"
      data-path="api/v1/roles/{role_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-roles--role_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-roles--role_id-"
                    onclick="tryItOut('GETapi-v1-roles--role_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-roles--role_id-"
                    onclick="cancelTryOut('GETapi-v1-roles--role_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-roles--role_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/roles/{role_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-roles--role_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-roles--role_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="role_id"                data-endpoint="GETapi-v1-roles--role_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the role. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-roles--role_id-">PUT api/v1/roles/{role_id}</h2>
...
<span id="example-requests-PUTapi-v1-roles--role_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-roles--role_id-">
</span>
<span id="execution-results-PUTapi-v1-roles--role_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-roles--role_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-roles--role_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-roles--role_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-roles--role_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-roles--role_id-" data-method="PUT"
      data-path="api/v1/roles/{role_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-roles--role_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-roles--role_id-"
                    onclick="tryItOut('PUTapi-v1-roles--role_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-roles--role_id-"
                    onclick="cancelTryOut('PUTapi-v1-roles--role_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-roles--role_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-roles--role_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-roles--role_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="role_id"                data-endpoint="PUTapi-v1-roles--role_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the role. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-roles--role_id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="guard_name"                data-endpoint="PUTapi-v1-roles--role_id-"
               value="api"
               data-component="body">
    <br>
<p>Example: <code>api</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="permissions[0]"                data-endpoint="PUTapi-v1-roles--role_id-"
               data-component="body">
        <input type="text" style="display: none"
               name="permissions[1]"                data-endpoint="PUTapi-v1-roles--role_id-"
               data-component="body">
    <br>
<p>The <code>name</code> of an existing record in the permissions table.</p>
        </div>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-roles--role_id-">DELETE api/v1/roles/{role_id}</h2>
...
<span id="example-requests-DELETEapi-v1-roles--role_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-roles--role_id-">
</span>
<span id="execution-results-DELETEapi-v1-roles--role_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-roles--role_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-roles--role_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-roles--role_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-roles--role_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-roles--role_id-" data-method="DELETE"
      data-path="api/v1/roles/{role_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-roles--role_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-roles--role_id-"
                    onclick="tryItOut('DELETEapi-v1-roles--role_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-roles--role_id-"
                    onclick="cancelTryOut('DELETEapi-v1-roles--role_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-roles--role_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-roles--role_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-roles--role_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="role_id"                data-endpoint="DELETEapi-v1-roles--role_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the role. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-roles--role_id--permissions">PUT api/v1/roles/{role_id}/permissions</h2>
...
<span id="example-requests-PUTapi-v1-roles--role_id--permissions">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/v1/roles/1/permissions" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"permissions\": [
...
<span id="example-responses-PUTapi-v1-roles--role_id--permissions">
</span>
<span id="execution-results-PUTapi-v1-roles--role_id--permissions" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-roles--role_id--permissions"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-roles--role_id--permissions"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-roles--role_id--permissions" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-roles--role_id--permissions">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-roles--role_id--permissions" data-method="PUT"
      data-path="api/v1/roles/{role_id}/permissions"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-roles--role_id--permissions', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-roles--role_id--permissions"
                    onclick="tryItOut('PUTapi-v1-roles--role_id--permissions');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-roles--role_id--permissions"
                    onclick="cancelTryOut('PUTapi-v1-roles--role_id--permissions');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-roles--role_id--permissions"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/v1/roles/{role_id}/permissions</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-roles--role_id--permissions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-roles--role_id--permissions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="role_id"                data-endpoint="PUTapi-v1-roles--role_id--permissions"
               value="1"
               data-component="url">
    <br>
<p>The ID of the role. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="permissions[0]"                data-endpoint="PUTapi-v1-roles--role_id--permissions"
               data-component="body">
        <input type="text" style="display: none"
               name="permissions[1]"                data-endpoint="PUTapi-v1-roles--role_id--permissions"
               data-component="body">
    <br>
<p>The <code>name</code> of an existing record in the permissions table.</p>
        </div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="search"                data-endpoint="GETapi-v1-permissions"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-v1-permissions"
               value="1"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 100. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^[a-z]+(?:.[a-z]+)+$/. Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>guard_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<ul style="list-style-type: square;"><li><code>api</code></li></ul>
                    ...
                    <h2 id="endpoints-GETapi-v1-permissions--permission_id-">GET api/v1/permissions/{permission_id}</h2>
...
<span id="example-requests-GETapi-v1-permissions--permission_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/permissions/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-v1-permissions--permission_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-permissions--permission_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-permissions--permission_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-permissions--permission_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-permissions--permission_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-permissions--permission_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-permissions--permission_id-" data-method="GET"
      data-path="api/v1/permissions/{permission_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-permissions--permission_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-permissions--permission_id-"
                    onclick="tryItOut('GETapi-v1-permissions--permission_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-permissions--permission_id-"
                    onclick="cancelTryOut('GETapi-v1-permissions--permission_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-permissions--permission_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/permissions/{permission_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-permissions--permission_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-permissions--permission_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="permission_id"                data-endpoint="GETapi-v1-permissions--permission_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the permission. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-permissions--permission_id-">PUT api/v1/permissions/{permission_id}</h2>
...
<span id="example-requests-PUTapi-v1-permissions--permission_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-permissions--permission_id-">
</span>
<span id="execution-results-PUTapi-v1-permissions--permission_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-permissions--permission_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-permissions--permission_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-permissions--permission_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-permissions--permission_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-permissions--permission_id-" data-method="PUT"
      data-path="api/v1/permissions/{permission_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-permissions--permission_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-permissions--permission_id-"
                    onclick="tryItOut('PUTapi-v1-permissions--permission_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-permissions--permission_id-"
                    onclick="cancelTryOut('PUTapi-v1-permissions--permission_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-permissions--permission_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-permissions--permission_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-permissions--permission_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="permission_id"                data-endpoint="PUTapi-v1-permissions--permission_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the permission. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-permissions--permission_id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must match the regex /^[a-z]+(?:.[a-z]+)+$/. Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="guard_name"                data-endpoint="PUTapi-v1-permissions--permission_id-"
               value="api"
               data-component="body">
    <br>
<p>Example: <code>api</code></p>
...
<ul style="list-style-type: square;"><li><code>api</code></li></ul>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-permissions--permission_id-">DELETE api/v1/permissions/{permission_id}</h2>
...
<span id="example-requests-DELETEapi-v1-permissions--permission_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-permissions--permission_id-">
</span>
<span id="execution-results-DELETEapi-v1-permissions--permission_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-permissions--permission_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-permissions--permission_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-permissions--permission_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-permissions--permission_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-permissions--permission_id-" data-method="DELETE"
      data-path="api/v1/permissions/{permission_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-permissions--permission_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-permissions--permission_id-"
                    onclick="tryItOut('DELETEapi-v1-permissions--permission_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-permissions--permission_id-"
                    onclick="cancelTryOut('DELETEapi-v1-permissions--permission_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-permissions--permission_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-permissions--permission_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-permissions--permission_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="permission_id"                data-endpoint="DELETEapi-v1-permissions--permission_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the permission. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-customer-register">POST api/v1/auth/customer/register</h2>
...
<span id="example-requests-POSTapi-v1-auth-customer-register">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/auth/customer/register" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"vmqeopfuudtdsufvyvddq\",
...
<span id="example-responses-POSTapi-v1-auth-customer-register">
</span>
<span id="execution-results-POSTapi-v1-auth-customer-register" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-customer-register"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-customer-register"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-customer-register" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-customer-register">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-customer-register" data-method="POST"
      data-path="api/v1/auth/customer/register"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-customer-register', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-customer-register"
                    onclick="tryItOut('POSTapi-v1-auth-customer-register');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-customer-register"
                    onclick="cancelTryOut('POSTapi-v1-auth-customer-register');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-customer-register"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/customer/register</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-customer-register"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-customer-register"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-auth-customer-register"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-v1-auth-customer-register"
               value="kunde.eloisa@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>kunde.eloisa@example.com</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-v1-auth-customer-register"
               value="4[*UyPJ"}6"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="POSTapi-v1-auth-customer-register"
               value="hdtqtqxbajwbpilpmufin"
               data-component="body">
    <br>
<p>Must be at least 8 characters. Must not be greater than 255 characters. Example: <code>hdtqtqxbajwbpilpmufin</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-v1-auth-customer-login">POST api/v1/auth/customer/login</h2>
...
<span id="example-requests-POSTapi-v1-auth-customer-login">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/auth/customer/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"qkunze@example.com\",
...
<span id="example-responses-POSTapi-v1-auth-customer-login">
</span>
<span id="execution-results-POSTapi-v1-auth-customer-login" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-customer-login"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-customer-login"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-customer-login" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-customer-login">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-customer-login" data-method="POST"
      data-path="api/v1/auth/customer/login"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-customer-login', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-customer-login"
                    onclick="tryItOut('POSTapi-v1-auth-customer-login');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-customer-login"
                    onclick="cancelTryOut('POSTapi-v1-auth-customer-login');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-customer-login"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/customer/login</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-customer-login"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-customer-login"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-v1-auth-customer-login"
               value="qkunze@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>qkunze@example.com</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-v1-auth-customer-login"
               value="O[2UZ5ij-e/dl4m{o,"
               data-component="body">
    <br>
<p>Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="device_name"                data-endpoint="POSTapi-v1-auth-customer-login"
...
<p>Must not be greater than 120 characters. Example: <code>dqamniihfqcoynlazghdt</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-admin-login">POST api/v1/auth/admin/login</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="device_name"                data-endpoint="POSTapi-v1-auth-admin-login"
               value="dqamniihfqcoynlazghdt"
               data-component="body">
    <br>
<p>Must not be greater than 120 characters. Example: <code>dqamniihfqcoynlazghdt</code></p>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>created_at</code></li> <li><code>-created_at</code></li> <li><code>price</code></li> <li><code>-price</code></li> <li><code>name</code></li> <li><code>-name</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/products/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/products/consequatur"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [App\\Models\\Ecommerce\\Product].&quot;,
    &quot;data&quot;: null
}</code>
 </pre>
    </span>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The slug of the product. Example: <code>consequatur</code></p>
            </div>
                    </form>
    ...
    &quot;data&quot;: [
        {
            ...
            &quot;slug&quot;: &quot;Electronic&quot;,
            &quot;is_active&quot;: true,
            &quot;created_at&quot;: &quot;2026-02-15T15:34:24.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-02-15T15:34:24.000000Z&quot;
        },
        {
            &quot;id&quot;: 1,
            &quot;parent_id&quot;: null,
            ...
            &quot;slug&quot;: &quot;andriod&quot;,
            &quot;is_active&quot;: true,
            &quot;created_at&quot;: &quot;2026-02-15T13:25:57.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-02-15T13:25:57.000000Z&quot;
        }
    ]
}</code>
 </pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;data&quot;: {
        &quot;guest_token&quot;: &quot;621bebe8-fcce-4a4b-b98f-6ed4ed347f2f&quot;,
        &quot;currency&quot;: &quot;USD&quot;,
        &quot;updated_at&quot;: &quot;2026-02-15T16:17:31.000000Z&quot;,
        &quot;created_at&quot;: &quot;2026-02-15T16:17:31.000000Z&quot;,
        &quot;id&quot;: 2,
        &quot;items&quot;: []
    }
}</code>
...
<p>Must be at least 1. Example: <code>45</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-v1-cart-items--item-">PATCH api/v1/cart/items/{item}</h2>
...
<span id="example-requests-PATCHapi-v1-cart-items--item-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-v1-cart-items--item-">
</span>
<span id="execution-results-PATCHapi-v1-cart-items--item-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-cart-items--item-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-cart-items--item-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-cart-items--item-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-cart-items--item-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-cart-items--item-" data-method="PATCH"
      data-path="api/v1/cart/items/{item}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-cart-items--item-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-cart-items--item-"
                    onclick="tryItOut('PATCHapi-v1-cart-items--item-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-cart-items--item-"
                    onclick="cancelTryOut('PATCHapi-v1-cart-items--item-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-cart-items--item-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-cart-items--item-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-cart-items--item-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="item"                data-endpoint="PATCHapi-v1-cart-items--item-"
               value="consequatur"
               data-component="url">
    <br>
<p>The item. Example: <code>consequatur</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>quantity</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="PATCHapi-v1-cart-items--item-"
               value="73"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>73</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-cart-items--item-">DELETE api/v1/cart/items/{item}</h2>
...
<form id="form-DELETEapi-v1-cart-items--item-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-cart-items--item-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-cart-items--item-"
                    onclick="cancelTryOut('DELETEapi-v1-cart-items--item-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The item. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-webhooks-payments-stripe">POST api/v1/webhooks/payments/stripe</h2>
...
<span id="example-requests-POSTapi-v1-webhooks-payments-stripe">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/webhooks/payments/stripe" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-webhooks-payments-stripe">
</span>
<span id="execution-results-POSTapi-v1-webhooks-payments-stripe" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-webhooks-payments-stripe"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-webhooks-payments-stripe"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-webhooks-payments-stripe" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-webhooks-payments-stripe">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-webhooks-payments-stripe" data-method="POST"
      data-path="api/v1/webhooks/payments/stripe"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-webhooks-payments-stripe', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-webhooks-payments-stripe"
                    onclick="tryItOut('POSTapi-v1-webhooks-payments-stripe');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-webhooks-payments-stripe"
                    onclick="cancelTryOut('POSTapi-v1-webhooks-payments-stripe');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-webhooks-payments-stripe"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/webhooks/payments/stripe</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-webhooks-payments-stripe"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-webhooks-payments-stripe"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-auth-customer-profile">GET api/v1/auth/customer/profile</h2>
...
<span id="example-requests-GETapi-v1-auth-customer-profile">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/auth/customer/profile" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/auth/customer/profile"
);
...
<span id="example-responses-GETapi-v1-auth-customer-profile">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-auth-customer-profile" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-auth-customer-profile"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-auth-customer-profile"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-auth-customer-profile" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-auth-customer-profile">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-auth-customer-profile" data-method="GET"
      data-path="api/v1/auth/customer/profile"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-auth-customer-profile', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-auth-customer-profile"
                    onclick="tryItOut('GETapi-v1-auth-customer-profile');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-auth-customer-profile"
                    onclick="cancelTryOut('GETapi-v1-auth-customer-profile');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-auth-customer-profile"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/auth/customer/profile</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-auth-customer-profile"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-auth-customer-profile"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-auth-customer-profile">PUT api/v1/auth/customer/profile</h2>
...
<span id="example-requests-PUTapi-v1-auth-customer-profile">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    --form "mobile_country_code=wbpilpmuf"\
    --form "mobile_number=inllwloauydlsmsjuryvo"\
    --form "profile_image=@/tmp/phpKuLBmy" </code></pre></div>
...
body.append('mobile_country_code', 'wbpilpmuf');
body.append('mobile_number', 'inllwloauydlsmsjuryvo');
...
<span id="example-responses-PUTapi-v1-auth-customer-profile">
</span>
<span id="execution-results-PUTapi-v1-auth-customer-profile" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-auth-customer-profile"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-auth-customer-profile"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-auth-customer-profile" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-auth-customer-profile">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-auth-customer-profile" data-method="PUT"
      data-path="api/v1/auth/customer/profile"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-auth-customer-profile', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-auth-customer-profile"
                    onclick="tryItOut('PUTapi-v1-auth-customer-profile');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-auth-customer-profile"
                    onclick="cancelTryOut('PUTapi-v1-auth-customer-profile');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-auth-customer-profile"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-auth-customer-profile"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-auth-customer-profile"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-auth-customer-profile"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-v1-auth-customer-profile"
               value="kunde.eloisa@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>kunde.eloisa@example.com</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address"                data-endpoint="PUTapi-v1-auth-customer-profile"
               value="hfqcoynlazghdtqtqxbaj"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>hfqcoynlazghdtqtqxbaj</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mobile_country_code"                data-endpoint="PUTapi-v1-auth-customer-profile"
               value="wbpilpmuf"
               data-component="body">
    <br>
<p>Must not be greater than 10 characters. Example: <code>wbpilpmuf</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mobile_number"                data-endpoint="PUTapi-v1-auth-customer-profile"
               value="inllwloauydlsmsjuryvo"
               data-component="body">
    <br>
<p>Must not be greater than 30 characters. Example: <code>inllwloauydlsmsjuryvo</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="profile_image"                data-endpoint="PUTapi-v1-auth-customer-profile"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 5120 kilobytes. Example: <code>/tmp/phpKuLBmy</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-v1-auth-customer-logout">POST api/v1/auth/customer/logout</h2>
...
<span id="example-requests-POSTapi-v1-auth-customer-logout">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/auth/customer/logout" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-auth-customer-logout">
</span>
<span id="execution-results-POSTapi-v1-auth-customer-logout" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-customer-logout"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-customer-logout"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-customer-logout" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-customer-logout">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-customer-logout" data-method="POST"
      data-path="api/v1/auth/customer/logout"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-customer-logout', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-customer-logout"
                    onclick="tryItOut('POSTapi-v1-auth-customer-logout');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-customer-logout"
                    onclick="cancelTryOut('POSTapi-v1-auth-customer-logout');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-customer-logout"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/customer/logout</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-customer-logout"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-customer-logout"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/auth/logout-all" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-cart-merge">POST api/v1/cart/merge</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"coupon_code\": \"vmqeopfuudtdsufvyvddq\",
    \"shipping_address\": {
        \"line1\": \"amniihfqcoynlazghdtqt\",
        \"city\": \"qxbajwbpilpmufinllwlo\",
        \"country\": \"au\",
        \"postal_code\": \"ydlsmsjuryvojcybz\"
    },
    \"address\": {
        \"line1\": \"vrbyickznkygloigmkwxp\",
        \"city\": \"hlvazjrcnfbaqywuxhgjj\",
        \"country\": \"mz\",
        \"zip\": \"uxjubqouzswiwxtrk\"
    },
    \"paymentId\": \"imfcatbxspzmrazsroyjp\",
    \"paymentMethod\": \"xmqesedyghenqcopwvown\",
    \"providerRef\": \"kbamlnfngefbeilfzsyux\",
    \"items\": [
        {
            \"product_id\": 17,
            \"productId\": 17,
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.product_id"                data-endpoint="POSTapi-v1-checkout"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the products table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.productId"                data-endpoint="POSTapi-v1-checkout"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the products table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.quantity"                data-endpoint="POSTapi-v1-checkout"
               value="45"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="shipping_address.line1"                data-endpoint="POSTapi-v1-checkout"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must not be greater than 255 characters. Example: <code>amniihfqcoynlazghdtqt</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must not be greater than 100 characters. Example: <code>qxbajwbpilpmufinllwlo</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must be 2 characters. Example: <code>au</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="shipping_address.postal_code"                data-endpoint="POSTapi-v1-checkout"
               value="ydlsmsjuryvojcybz"
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must not be greater than 20 characters. Example: <code>ydlsmsjuryvojcybz</code></p>
                    </div>
                                    </details>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.line1"                data-endpoint="POSTapi-v1-checkout"
               value="vrbyickznkygloigmkwxp"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must not be greater than 255 characters. Example: <code>vrbyickznkygloigmkwxp</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>city</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.city"                data-endpoint="POSTapi-v1-checkout"
               value="hlvazjrcnfbaqywuxhgjj"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must not be greater than 100 characters. Example: <code>hlvazjrcnfbaqywuxhgjj</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>country</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.country"                data-endpoint="POSTapi-v1-checkout"
               value="mz"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must be 2 characters. Example: <code>mz</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.zip"                data-endpoint="POSTapi-v1-checkout"
               value="uxjubqouzswiwxtrk"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must not be greater than 20 characters. Example: <code>uxjubqouzswiwxtrk</code></p>
                    </div>
                                    </details>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="paymentId"                data-endpoint="POSTapi-v1-checkout"
               value="imfcatbxspzmrazsroyjp"
               data-component="body">
    <br>
<p>Must not be greater than 120 characters. Example: <code>imfcatbxspzmrazsroyjp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="paymentMethod"                data-endpoint="POSTapi-v1-checkout"
               value="xmqesedyghenqcopwvown"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>xmqesedyghenqcopwvown</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>providerRef</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="providerRef"                data-endpoint="POSTapi-v1-checkout"
               value="kbamlnfngefbeilfzsyux"
               data-component="body">
    <br>
<p>Must not be greater than 120 characters. Example: <code>kbamlnfngefbeilfzsyux</code></p>
        </div>
        </form>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="items.0.productId"                data-endpoint="POSTapi-v1-orders"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the products table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="shipping_address.line1"                data-endpoint="POSTapi-v1-orders"
               value="amniihfqcoynlazghdtqt"
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must not be greater than 255 characters. Example: <code>amniihfqcoynlazghdtqt</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="shipping_address.city"                data-endpoint="POSTapi-v1-orders"
               value="qxbajwbpilpmufinllwlo"
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must not be greater than 100 characters. Example: <code>qxbajwbpilpmufinllwlo</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="shipping_address.country"                data-endpoint="POSTapi-v1-orders"
               value="au"
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must be 2 characters. Example: <code>au</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="shipping_address.postal_code"                data-endpoint="POSTapi-v1-orders"
               value="ydlsmsjuryvojcybz"
               data-component="body">
    <br>
<p>This field is required when <code>shipping_address</code> is present. Must not be greater than 20 characters. Example: <code>ydlsmsjuryvojcybz</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.line1"                data-endpoint="POSTapi-v1-orders"
               value="vrbyickznkygloigmkwxp"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must not be greater than 255 characters. Example: <code>vrbyickznkygloigmkwxp</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.city"                data-endpoint="POSTapi-v1-orders"
               value="hlvazjrcnfbaqywuxhgjj"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must not be greater than 100 characters. Example: <code>hlvazjrcnfbaqywuxhgjj</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.country"                data-endpoint="POSTapi-v1-orders"
               value="mz"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must be 2 characters. Example: <code>mz</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address.zip"                data-endpoint="POSTapi-v1-orders"
               value="uxjubqouzswiwxtrk"
               data-component="body">
    <br>
<p>This field is required when <code>address</code> is present. Must not be greater than 20 characters. Example: <code>uxjubqouzswiwxtrk</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="paymentId"                data-endpoint="POSTapi-v1-orders"
               value="imfcatbxspzmrazsroyjp"
               data-component="body">
    <br>
<p>Must not be greater than 120 characters. Example: <code>imfcatbxspzmrazsroyjp</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="paymentMethod"                data-endpoint="POSTapi-v1-orders"
               value="xmqesedyghenqcopwvown"
               data-component="body">
    <br>
<p>Must not be greater than 50 characters. Example: <code>xmqesedyghenqcopwvown</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="providerRef"                data-endpoint="POSTapi-v1-orders"
               value="kbamlnfngefbeilfzsyux"
               data-component="body">
    <br>
<p>Must not be greater than 120 characters. Example: <code>kbamlnfngefbeilfzsyux</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-orders--order-">GET api/v1/orders/{order}</h2>
...
<div class="bash-example">
    ...
    \"is_active\": true,
    \"status\": \"inactive\",
    \"published_at\": \"2026-02-15T16:17:31\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="compare_at_price"                data-endpoint="POSTapi-v1-admin-products"
               value="66"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="published_at"                data-endpoint="POSTapi-v1-admin-products"
               value="2026-02-15T16:17:31"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-15T16:17:31</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-v1-admin-products--product-">GET api/v1/admin/products/{product}</h2>
...
<span id="example-requests-GETapi-v1-admin-products--product-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/admin/products/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/admin/products/consequatur"
);
...
<span id="example-responses-GETapi-v1-admin-products--product-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-admin-products--product-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-products--product-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-products--product-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-products--product-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-products--product-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-products--product-" data-method="GET"
      data-path="api/v1/admin/products/{product}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-products--product-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-products--product-"
                    onclick="tryItOut('GETapi-v1-admin-products--product-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-products--product-"
                    onclick="cancelTryOut('GETapi-v1-admin-products--product-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-products--product-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-products--product-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-products--product-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="product"                data-endpoint="GETapi-v1-admin-products--product-"
               value="consequatur"
               data-component="url">
    <br>
<p>The product. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-admin-products--product-">PUT api/v1/admin/products/{product}</h2>
...
<span id="example-requests-PUTapi-v1-admin-products--product-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-admin-products--product-">
</span>
<span id="execution-results-PUTapi-v1-admin-products--product-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-admin-products--product-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-admin-products--product-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-admin-products--product-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-admin-products--product-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-admin-products--product-" data-method="PUT"
      data-path="api/v1/admin/products/{product}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-admin-products--product-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-admin-products--product-"
                    onclick="tryItOut('PUTapi-v1-admin-products--product-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-admin-products--product-"
                    onclick="cancelTryOut('PUTapi-v1-admin-products--product-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-admin-products--product-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="product"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="consequatur"
               data-component="url">
    <br>
<p>The product. Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="17"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table. Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sku"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 100 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="mniihfqcoynlazghdtqtq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>mniihfqcoynlazghdtqtq</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="xbajwbpilpmufinllwloa"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>xbajwbpilpmufinllwloa</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="Dolores dolorum amet iste laborum eius est dolor."
               data-component="body">
    <br>
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="price"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="12"
               data-component="body">
    <br>
<p>Must be at least 0. Example: <code>12</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="compare_at_price"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="66"
               data-component="body">
    <br>
<p>Must be at least 0. Example: <code>66</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="stock"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="13"
               data-component="body">
    <br>
<p>Must be at least 0. Example: <code>13</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-v1-admin-products--product-" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="PUTapi-v1-admin-products--product-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-v1-admin-products--product-" style="display: none">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="inactive"
               data-component="body">
    <br>
<p>Example: <code>inactive</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="published_at"                data-endpoint="PUTapi-v1-admin-products--product-"
               value="2026-02-15T16:17:31"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-15T16:17:31</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-admin-products--product-">DELETE api/v1/admin/products/{product}</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="product"                data-endpoint="DELETEapi-v1-admin-products--product-"
               value="consequatur"
               data-component="url">
    <br>
<p>The product. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-products--product--images">POST api/v1/admin/products/{product}/images</h2>
...
<span id="example-requests-POSTapi-v1-admin-products--product--images">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/admin/products/consequatur/images" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "is_primary="\
    --form "image=@/tmp/phpIkRiDX" </code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-products--product--images">
</span>
<span id="execution-results-POSTapi-v1-admin-products--product--images" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-products--product--images"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-products--product--images"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-products--product--images" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-products--product--images">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-products--product--images" data-method="POST"
      data-path="api/v1/admin/products/{product}/images"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-products--product--images', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-products--product--images"
                    onclick="tryItOut('POSTapi-v1-admin-products--product--images');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-products--product--images"
                    onclick="cancelTryOut('POSTapi-v1-admin-products--product--images');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-products--product--images"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/products/{product}/images</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-products--product--images"
               value="multipart/form-data"
               data-component="header">
    <br>
<p>Example: <code>multipart/form-data</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-products--product--images"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="product"                data-endpoint="POSTapi-v1-admin-products--product--images"
               value="consequatur"
               data-component="url">
    <br>
<p>The product. Example: <code>consequatur</code></p>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="POSTapi-v1-admin-products--product--images"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 5120 kilobytes. Example: <code>/tmp/phpIkRiDX</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-v1-admin-products--product--images" style="display: none">
            <input type="radio" name="is_primary"
                   value="true"
                   data-endpoint="POSTapi-v1-admin-products--product--images"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-v1-admin-products--product--images" style="display: none">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="from"                data-endpoint="GETapi-v1-admin-orders"
               value="2026-02-15T16:17:31"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-15T16:17:31</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="to"                data-endpoint="GETapi-v1-admin-orders"
               value="2107-03-17"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>from</code>. Example: <code>2107-03-17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-v1-admin-orders"
               value="13"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 100. Example: <code>13</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-orders--order-">GET api/v1/admin/orders/{order}</h2>
...
<span id="example-requests-GETapi-v1-admin-orders--order-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-admin-orders--order-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-admin-orders--order-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-orders--order-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-orders--order-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-orders--order-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-orders--order-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-orders--order-" data-method="GET"
      data-path="api/v1/admin/orders/{order}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-orders--order-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-orders--order-"
                    onclick="tryItOut('GETapi-v1-admin-orders--order-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-orders--order-"
                    onclick="cancelTryOut('GETapi-v1-admin-orders--order-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-orders--order-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/admin/orders/{order}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-orders--order-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-orders--order-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="order"                data-endpoint="GETapi-v1-admin-orders--order-"
               value="consequatur"
               data-component="url">
    <br>
<p>The order. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-v1-admin-orders--order--status">PATCH api/v1/admin/orders/{order}/status</h2>
...
<span id="example-requests-PATCHapi-v1-admin-orders--order--status">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-v1-admin-orders--order--status">
</span>
<span id="execution-results-PATCHapi-v1-admin-orders--order--status" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-admin-orders--order--status"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-admin-orders--order--status"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-admin-orders--order--status" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-admin-orders--order--status">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-admin-orders--order--status" data-method="PATCH"
      data-path="api/v1/admin/orders/{order}/status"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-admin-orders--order--status', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-admin-orders--order--status"
                    onclick="tryItOut('PATCHapi-v1-admin-orders--order--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-admin-orders--order--status"
                    onclick="cancelTryOut('PATCHapi-v1-admin-orders--order--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-admin-orders--order--status"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/v1/admin/orders/{order}/status</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-admin-orders--order--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-admin-orders--order--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="order"                data-endpoint="PATCHapi-v1-admin-orders--order--status"
               value="consequatur"
               data-component="url">
    <br>
<p>The order. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PATCHapi-v1-admin-orders--order--status"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
